...
toc: true
toc_label: "内容目录"
toc_icon: "list-ul"  # 可选：cog, file, list-ul 等
toc_sticky: true      # 使目录随页面滚动
...
![动画图](/assets/images/AnimationGraph.png)

# 行为树编辑器

支持节点的图形化编辑、运行时状态监控、操作撤销。
![编辑窗口外观](/assets/images/BTEditor.png)

# 角色控制

实现了一个简单的可以进行奔跑、连段普通攻击、普攻衔接重击的角色，以及简单的伤害和Buff逻辑。
<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%;">
    <iframe src="//player.bilibili.com/player.html?isOutside=true&aid=116233743638147&bvid=BV1ohw3zmErb&cid=36722968961&p=1&high_quality=1&autoplay=0"
